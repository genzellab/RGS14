function [swr_hpc,swr_pfc,s_hpc,s_pfc,V_hpc,V_pfc,signal2_hpc,signal2_pfc,sd_swr, M_multiplets, Mx_multiplets, multiplets, ripples, Mono_hpc, Mono_pfc,total_swrs,total_NREM_min,v_index, v_values,v_timestamps, S_r, M_r, E_r] = ripple_detection(HPC,Cortex,states,ss,offset1,offset2,TT,j,i) 
