function newmap = colorbar_cluster12(m)
...
% colors here
bottom = [10/255 175/255 211/255];
botmiddle = [44/255 210/255 245/255];
middle = [1 1 1];
topmiddle = [209/255 233/255 196/255];
top = [170/255 213/255 146/255];
